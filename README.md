...
Because each resource needs a globally unique id. Part of normalizing data tables.
...
An intermediary table. The primary keys and foreign keys are represented by numbers that may repeat but different combinations of these numbers in the third table makes each row unique. We do this to avoid denormalizing our data (repeating data or multiple data points).
